...
Write-Output "`n${scriptName} -> Iniciando el proceso para insertar datos de prueba en la base de datos (básico)."

# Definición de credenciales y nombre de la base de datos
$dbUser = "root"
$dbPassword = "root"
$dbName = "data_burst"
$inputFile = (Get-Item "poblar-bd-basico.sql").FullName  # Ruta absoluta
